...
% Last Modified by GUIDE v2.5 19-Jul-2017 22:50:56
...
% --- Executes on button press in Random_Walk.
function Random_Walk_Callback(hObject, eventdata, handles)
% hObject    handle to Random_Walk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Random_Walk
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ImageFunctionPool('NVRemove',hObject,eventdata,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ImageFunctionPool('NVAdd',hObject,eventdata,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ImageFunctionPool('NVUpdate',hObject,eventdata,handles);
...
function Catalog_Number_Callback(hObject, eventdata, handles)
% hObject    handle to Catalog_Number (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Catalog_Number as text
%        str2double(get(hObject,'String')) returns contents of Catalog_Number as a double


% --- Executes during object creation, after setting all properties.
function Catalog_Number_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Catalog_Number (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in sr620Button.
function sr620Button_Callback(hObject, eventdata, handles)
% hObject    handle to sr620Button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of sr620Button
